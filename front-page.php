...
<main id="main" class="front-page" role="main">
    ...
    <!-- =========================================================================
         TRUST BADGES - 信頼バッジ
         ========================================================================= -->
    <section class="trust-badges" aria-label="信頼の実績">
        <div class="container">
            <ul class="trust-badges__list">
                <li class="trust-badges__item scroll-reveal">
                    <div class="trust-badges__icon">
                        <?php sato_icon('award', 32); ?>
                    </div>
                    <div class="trust-badges__content">
                        <span class="trust-badges__title">一級塗装技能士</span>
                        <span class="trust-badges__desc">国家資格保有の職人が施工</span>
                    </div>
                </li>
                <li class="trust-badges__item scroll-reveal" style="--delay: 0.1s">
                    ...
                    <div class="trust-badges__content">
                        <span class="trust-badges__title">最長<?php echo esc_html($warranty_years); ?>年保証</span>
                        <span class="trust-badges__desc">安心の長期保証付き</span>
                    </div>
                </li>
                <li class="trust-badges__item scroll-reveal" style="--delay: 0.2s">
                    ...
                    <div class="trust-badges__content">
                        <span class="trust-badges__title">完全自社施工</span>
                        <span class="trust-badges__desc">下請けなしの直接施工</span>
                    </div>
                </li>
                <li class="trust-badges__item scroll-reveal" style="--delay: 0.3s">
                    ...
                    <div class="trust-badges__content">
                        <span class="trust-badges__title">地域密着<?php echo esc_html($years_business); ?>年</span>
                        <span class="trust-badges__desc">御殿場市を中心に対応</span>
                    </div>
                </li>
            </ul>
        </div>
                        ...
                        <div class="simulator__checkboxes">
                            <label class="simulator__checkbox">
                                ...
                                <span class="simulator__checkbox-inner">
                                    ...
                                    <span><strong>外壁塗装</strong><small>80万円〜</small></span>
                                </span>
                            </label>
                            <label class="simulator__checkbox">
                                ...
                                <span class="simulator__checkbox-inner">
                                    <?php sato_icon('check', 18); ?>
                                    <span><strong>屋根塗装</strong><small>50万円〜</small></span>
                                </span>
                            </label>
                            <label class="simulator__checkbox">
                                ...
                                <span class="simulator__checkbox-inner">
                                    <?php sato_icon('check', 18); ?>
                                    <span><strong>付帯部塗装</strong><small>20万円〜</small></span>
                                </span>
                            </label>
                            <label class="simulator__checkbox">
                                ...
                                <span class="simulator__checkbox-inner">
                                    <?php sato_icon('check', 18); ?>
                                    <span><strong>防水工事</strong><small>30万円〜</small></span>
                                </span>
                            </label>
                        </div>
                    </div>
        ...
        <div class="container">
            <header class="section__header section__header--center">
                ...
                <h2 class="section__title scroll-reveal" id="flow-heading">
                    <span class="marker marker--primary">ご依頼の流れ</span>
                </h2>
                <p class="section__lead scroll-reveal">
                    お問い合わせから施工完了まで、<br>
                    丁寧にサポートいたします。
            ...
            <ol class="flow__steps">
                ...
                <li class="flow-step scroll-reveal" style="--delay: 0.1s">
                    <div class="flow-step__number"><span>02</span></div>
                    <div class="flow-step__content">
                        <h3 class="flow-step__title">現地調査・診断（無料）</h3>
                        <p class="flow-step__text">
                            専門スタッフがお住まいにお伺いし、外壁・屋根の状態を詳しく診断。写真撮影してご報告します。
                        </p>
                    </div>
                    <div class="flow-step__icon">
                ...
                <li class="flow-step scroll-reveal" style="--delay: 0.2s">
                    <div class="flow-step__number"><span>03</span></div>
                    <div class="flow-step__content">
                        <h3 class="flow-step__title">お見積り・ご提案</h3>
                        <p class="flow-step__text">
                            診断結果をもとに、最適なプランとお見積りをご提案。ご不明点は何でもお聞きください。
                        </p>
                    </div>
                    <div class="flow-step__icon">
                        <?php sato_icon('file-text', 32); ?>
                    </div>
                </li>

                <li class="flow-step scroll-reveal" style="--delay: 0.3s">
                    <div class="flow-step__number"><span>04</span></div>
                    <div class="flow-step__content">
                        <h3 class="flow-step__title">ご契約・色決め</h3>
                        <p class="flow-step__text">
                            ご納得いただけましたらご契約。カラーシミュレーションで理想の色をじっくりお選びいただけます。
                        </p>
                    </div>
                    <div class="flow-step__icon">
                ...
                <li class="flow-step scroll-reveal" style="--delay: 0.4s">
                    <div class="flow-step__number"><span>05</span></div>
                    <div class="flow-step__content">
                        <h3 class="flow-step__title">施工開始</h3>
                        <p class="flow-step__text">
                            近隣へのご挨拶後、足場設置から丁寧に施工。進捗は随時ご報告いたします。
                        </p>
                    </div>
                    <div class="flow-step__icon">
                        <?php sato_icon('tool', 32); ?>
                ...
                <li class="flow-step scroll-reveal" style="--delay: 0.5s">
                    <div class="flow-step__number"><span>06</span></div>
                    <div class="flow-step__content">
                        <h3 class="flow-step__title">完工・お引き渡し</h3>
                        <p class="flow-step__text">
                            最終確認後、保証書をお渡しして完了。アフターフォローもお任せください。
                        </p>
                    </div>
                    <div class="flow-step__icon">
                        <?php sato_icon('shield-check', 32); ?>
        ...
        <div class="container">
            <header class="section__header section__header--center">
                ...
                <h2 class="section__title scroll-reveal" id="area-heading">
                    <span class="marker marker--primary">対応エリア</span>
                </h2>
                <p class="section__lead scroll-reveal">
                    静岡県東部を中心に、地域密着でサービスを提供しています。
                </p>
            </header>

            <div class="area__content scroll-reveal">
                <div class="area__map">
                    <?php 
                    ...
                    ?>
                        <iframe 
                            ...
                            title="<?php echo esc_attr($company_name); ?>の対応エリア">
                        </iframe>
                    <?php else : ?>
    ...
    <section class="section news" aria-labelledby="news-heading">
        <div class="container">
            ...
            <ul class="news__list">
                <?php
                $news_query = sato_get_news(['posts_per_page' => 5]);
                ...
                <li class="news-item scroll-reveal">
                    <span class="news-item__link">
                        <time class="news-item__date"><?php echo date('Y.m.d'); ?></time>
                        <span class="news-item__category">お知らせ</span>
                        <span class="news-item__title">ホームページをリニューアルしました</span>
                    </span>
                </li>
                <?php endif; ?>
            </ul>
