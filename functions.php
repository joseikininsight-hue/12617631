...
if (!function_exists('sato_get_company_name')) {
    function sato_get_company_name($full = false) {
        ...
        return get_theme_mod('sato_company_name', 'サトー建装');
            ...
            'paint-bucket'   => '<svg ' . $attr_stroke . '><path d="M19 11h-6V5h6a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2z"/><path d="M13 5V3a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v18l4-3 4 3V5z"/><circle cx="21" cy="18" r="2"/></svg>',
            'roller'         => '<svg ' . $attr_stroke . '><rect x="2" y="3" width="16" height="5" rx="1"/><path d="M18 5h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-4"/><path d="M12 10v9a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1v-9"/></svg>',
            'building'       => '<svg ' . $attr_stroke . '><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',
            ...
            'message-square' => '<svg ' . $attr_stroke . '><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',
            ...
            'list'           => '<svg ' . $attr_stroke . '><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>',
            ...
            'star-half'      => '<svg ' . $attr_fill . '><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77V2z"/><path d="M12 2v15.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" fill="none" stroke="currentColor" stroke-width="2"/></svg>',
            'thumbs-up'      => '<svg ' . $attr_stroke . '><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"/></svg>',
            ...
            'google'         => '<svg ' . $attr_fill . '><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg>',
        ];
